...
import info.movito.themoviedbapi.model.tv.tvseries.AlternativeTitleResults;
import info.movito.themoviedbapi.model.tv.tvseries.ChangeResults;
import info.movito.themoviedbapi.model.tv.tvseries.ContentRatingResults;
import info.movito.themoviedbapi.model.tv.tvseries.EpisodeGroupResults;
import info.movito.themoviedbapi.model.tv.tvseries.ExternalIds;
import info.movito.themoviedbapi.model.tv.tvseries.Images;
import info.movito.themoviedbapi.model.tv.tvseries.ScreenedTheatricallyResults;
import info.movito.themoviedbapi.model.tv.tvseries.Translations;
import info.movito.themoviedbapi.model.tv.tvseries.TvSeriesDb;
import info.movito.themoviedbapi.model.tv.tvseries.TvSeriesListResultsPage;
...
public class TmdbTvSeriesTest extends AbstractTmdbApiTest {
    ...
    public void testGetDetails() throws IOException, TmdbException {
        ...
        filteredModel.add("info.movito.themoviedbapi.model.tv.tvseries.TvSeriesDb.accountStates");
        filteredModel.add("info.movito.themoviedbapi.model.tv.tvseries.TvSeriesDb.aggregateCredits");
        filteredModel.add("info.movito.themoviedbapi.model.tv.tvseries.TvSeriesDb.alternativeTitles");
        filteredModel.add("info.movito.themoviedbapi.model.tv.tvseries.TvSeriesDb.changes");
        filteredModel.add("info.movito.themoviedbapi.model.tv.tvseries.TvSeriesDb.contentRatings");
        filteredModel.add("info.movito.themoviedbapi.model.tv.tvseries.TvSeriesDb.credits");
        filteredModel.add("info.movito.themoviedbapi.model.tv.tvseries.TvSeriesDb.episodeGroups");
        filteredModel.add("info.movito.themoviedbapi.model.tv.tvseries.TvSeriesDb.externalIds");
        filteredModel.add("info.movito.themoviedbapi.model.tv.tvseries.TvSeriesDb.images");
        filteredModel.add("info.movito.themoviedbapi.model.tv.tvseries.TvSeriesDb.keywords");
        filteredModel.add("info.movito.themoviedbapi.model.tv.tvseries.TvSeriesDb.lists");
        filteredModel.add("info.movito.themoviedbapi.model.tv.tvseries.TvSeriesDb.recommendations");
        filteredModel.add("info.movito.themoviedbapi.model.tv.tvseries.TvSeriesDb.reviews");
        filteredModel.add("info.movito.themoviedbapi.model.tv.tvseries.TvSeriesDb.screenedTheatrically");
        filteredModel.add("info.movito.themoviedbapi.model.tv.tvseries.TvSeriesDb.similar");
        filteredModel.add("info.movito.themoviedbapi.model.tv.tvseries.TvSeriesDb.translations");
        filteredModel.add("info.movito.themoviedbapi.model.tv.tvseries.TvSeriesDb.videos");
        filteredModel.add("info.movito.themoviedbapi.model.tv.tvseries.TvSeriesDb.watchProviders");
