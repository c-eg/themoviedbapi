...
import uk.co.conoregan.themoviedbapi.model.core.multi.Multi;
import uk.co.conoregan.themoviedbapi.model.core.multi.MultiCollection;
import uk.co.conoregan.themoviedbapi.model.core.multi.MultiMovie;
import uk.co.conoregan.themoviedbapi.model.core.multi.MultiPerson;
import uk.co.conoregan.themoviedbapi.model.core.multi.MultiResultsPage;
import uk.co.conoregan.themoviedbapi.model.core.multi.MultiTvSeries;
import uk.co.conoregan.themoviedbapi.model.core.popularperson.PopularPersonResultsPage;
import uk.co.conoregan.themoviedbapi.model.search.CollectionResultsPage;
import uk.co.conoregan.themoviedbapi.model.search.CompanyResultsPage;
import uk.co.conoregan.themoviedbapi.model.search.KeywordResultsPage;
...
public class TmdbSearchTest extends AbstractTmdbApiTest<TmdbSearch> {
    ...
    public void testSearchMulti() throws IOException, TmdbException {
        ...
        ValidatorConfig multiValidatorConfig = ValidatorConfig.builder()
            .emptyCollectionFieldsToIgnore(List.of("uk.co.conoregan.themoviedbapi.model.core.multi.MultiResultsPage.results.originCountry"))
            .build();
        ...
        ValidatorConfig validatorConfig = ValidatorConfig.builder()
            .emptyCollectionFieldsToIgnore(List.of("uk.co.conoregan.themoviedbapi.model.core.multi.MultiMovie.originCountry"))
            .build();
