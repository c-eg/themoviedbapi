...
import uk.co.conoregan.themoviedbapi.model.movies.AlternativeTitles;
import uk.co.conoregan.themoviedbapi.model.movies.Credits;
import uk.co.conoregan.themoviedbapi.model.movies.ExternalIds;
import uk.co.conoregan.themoviedbapi.model.movies.Images;
import uk.co.conoregan.themoviedbapi.model.movies.KeywordResults;
...
import uk.co.conoregan.themoviedbapi.model.movies.ReleaseDateResults;
import uk.co.conoregan.themoviedbapi.model.movies.Translations;
...
import uk.co.conoregan.themoviedbapi.tools.appendtoresponse.MovieAppendToResponse;
import uk.co.conoregan.themoviedbapi.util.JsonUtil;

import static org.junit.jupiter.api.Assertions.assertEquals;
import static org.junit.jupiter.api.Assertions.assertNotNull;
import static org.mockito.Mockito.when;
import static uk.co.conoregan.themoviedbapi.TmdbMovies.TMDB_METHOD_MOVIE;
...
public class TmdbMoviesTest extends AbstractTmdbApiTest<TmdbMovies> {
    ...
    public void testGetDetails() throws IOException, TmdbException {
        ...
        ValidatorConfig validatorConfig = ValidatorConfig.builder()
            .nullFieldsToIgnore(List.of(
                "uk.co.conoregan.themoviedbapi.model.movies.MovieDb.accountStates",
                "uk.co.conoregan.themoviedbapi.model.movies.MovieDb.alternativeTitles",
                "uk.co.conoregan.themoviedbapi.model.movies.MovieDb.credits",
                "uk.co.conoregan.themoviedbapi.model.movies.MovieDb.changes",
                "uk.co.conoregan.themoviedbapi.model.movies.MovieDb.externalIds",
                "uk.co.conoregan.themoviedbapi.model.movies.MovieDb.images",
                "uk.co.conoregan.themoviedbapi.model.movies.MovieDb.keywords",
                "uk.co.conoregan.themoviedbapi.model.movies.MovieDb.recommendations",
                "uk.co.conoregan.themoviedbapi.model.movies.MovieDb.releaseDates",
                "uk.co.conoregan.themoviedbapi.model.movies.MovieDb.lists",
                "uk.co.conoregan.themoviedbapi.model.movies.MovieDb.reviews",
                "uk.co.conoregan.themoviedbapi.model.movies.MovieDb.similar",
                "uk.co.conoregan.themoviedbapi.model.movies.MovieDb.translations",
                "uk.co.conoregan.themoviedbapi.model.movies.MovieDb.videos",
                "uk.co.conoregan.themoviedbapi.model.movies.MovieDb.watchProviders"
            ))
            .build();
    ...
    public void testGetDetailsWithAppendToResponse() throws IOException, TmdbException {
        ...
        ValidatorConfig validatorConfig = ValidatorConfig.builder()
            .emptyCollectionFieldsToIgnore(List.of(
                "uk.co.conoregan.themoviedbapi.model.movies.MovieDb.recommendations.results.originCountry",
                "uk.co.conoregan.themoviedbapi.model.movies.MovieDb.similar.results.originCountry"
            ))
            .build();
        TestUtils.validateAbstractJsonMappingFields(movie, validatorConfig);
    }
    ...
    public void testGetLatest() throws IOException, TmdbException {
        ...
        ValidatorConfig validatorConfig = ValidatorConfig.builder()
            ...
            .emptyCollectionFieldsToIgnore(List.of(
                ...
                "uk.co.conoregan.themoviedbapi.model.movies.MovieDb.originCountry"
            ))
            .build();
        TestUtils.validateAbstractJsonMappingFields(movie, validatorConfig);
    }
    ...
    public void testGetRecommendations() throws IOException, TmdbException {
        ...
        ValidatorConfig validatorConfig = ValidatorConfig.builder()
            .emptyCollectionFieldsToIgnore(List.of(
                "uk.co.conoregan.themoviedbapi.model.core.MovieResultsPage.results.originCountry"
            ))
            .build();
