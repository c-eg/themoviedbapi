...
import uk.co.conoregan.themoviedbapi.model.lists.ListDetails;
import uk.co.conoregan.themoviedbapi.model.lists.ListItemStatus;
import uk.co.conoregan.themoviedbapi.model.lists.MovieListCreationStatus;
...
import static uk.co.conoregan.themoviedbapi.TmdbLists.TMDB_METHOD_LIST;
...
public class TmdbListsTest extends AbstractTmdbApiTest<TmdbLists> {
    ...
    public void testGetDetails() throws IOException, TmdbException {
        ...
        ValidatorConfig validatorConfig = ValidatorConfig.builder()
            .emptyCollectionFieldsToIgnore(List.of("uk.co.conoregan.themoviedbapi.model.lists.ListDetails.items.originCountry"))
            .build();
