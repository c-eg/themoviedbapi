...
import static uk.co.conoregan.themoviedbapi.api.TmdbCollections.TMDB_METHOD_COLLECTION;
import static uk.co.conoregan.themoviedbapi.api.TmdbLists.TMDB_METHOD_LIST;
import static uk.co.conoregan.themoviedbapi.api.TmdbMovies.TMDB_METHOD_MOVIE;
...
public class TmdbSearch extends AbstractTmdbApi {
    ...
    public TvSeriesDbResultsPage searchTv(String query, Integer searchYear, String language, boolean includeAdult,
        ...
        ApiEndpoint apiEndpoint = new ApiEndpoint(TMDB_METHOD_SEARCH, TMDB_METHOD_TV);
        apiEndpoint.addPathParam(PARAM_QUERY, query);
    ...
    public CollectionResultsPage searchCollection(String query, String language, boolean includeAdult, Integer page) throws TmdbException {
        ApiEndpoint apiEndpoint = new ApiEndpoint(TMDB_METHOD_SEARCH, TMDB_METHOD_COLLECTION);
