...
public class TmdbTvEpisodes extends AbstractApiElement {
    ...
    public static final String TMDB_METHOD_TV_SEASON = "episode";
    ...
    public TvEpisode getEpisode(int seriesId, int seasonNumber, int episodeNumber, String language, EpisodeMethod... appendToResponse) {
        ApiUrl apiUrl = new ApiUrl(TmdbTV.TMDB_METHOD_TV, seriesId, TmdbTvSeasons.TMDB_METHOD_TV_SEASON, seasonNumber, TMDB_METHOD_TV_SEASON, episodeNumber);
