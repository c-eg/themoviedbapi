...
public final class WebBrowser implements UrlReader {
    ...
    private static final Map<String, String> browserProperties = new HashMap<>();
            ...
            if ("Set-Cookie".equals(header.getKey())) {
                for (String cookieHeader : header.getValue()) {
                    ...
                    if (cookieElements.length >= 1) {
                        ...
                        Map<String, String> domainCookies = cookies.computeIfAbsent(cookieDomain, k -> new HashMap<>());
    ...
    /**
     * Sets the proxy password and encodes it.
     */
    public static void setProxyPassword(String myProxyPassword) {
        ...
        if (proxyUsername != null) {
            ...
            proxyEncodedPassword =
                "Basic " + new String(Base64.encodeBase64((proxyUsername + ":" + proxyPassword).getBytes()));
        }
    }
    ...
    @Override
    public String request(URL url, String jsonBody, RequestType requestType) {
        return request(url, jsonBody, requestType.equals(RequestType.DELETE));
    }
    ...
    public static String request(URL url, String jsonBody, boolean isDeleteRequest) {
        ...
        try {
            ...
            if (cnx.getHeaderField("Retry-After") != null) {
                throw new RequestCountLimitException(content.toString(),
                    Integer.parseInt(cnx.getHeaderField("Retry-After")));
            }
    ...
    public String request(String url) {
        try {
            return request(new URL(url), null, RequestType.GET);
        }
